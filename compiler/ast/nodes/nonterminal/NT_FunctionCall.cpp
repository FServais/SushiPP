...
using namespace ast::nodes::nonterminals::nt_functioncall;
...
FuncCall::FuncCall(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("funccall", node_loc)
{
...
ArgList::ArgList(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("arglist", node_loc)
{
...
Argument::Argument(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("argument", node_loc)
{
...
BracedFuncCall::BracedFuncCall(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("bracedfunccall", node_loc)
{
...
FuncCallEol::FuncCallEol(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("funccalleol", node_loc)
{
...
ArgListEol::ArgListEol(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("arglisteol", node_loc)
{
...
SoyExpression::SoyExpression(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("soyexpression", node_loc)
{
...
SoyFunc::SoyFunc(const ast::nodes::NodeLocation& node_loc) : NT_FunctionCall("soyfunc", node_loc)
{

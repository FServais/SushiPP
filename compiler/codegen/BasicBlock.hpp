...
namespace codegen
{
    ...
    public:
         ...
         * @retval std::string When the ret argument is omitted, an empty string is returned, otherwise the name of the variable 
         * generated by the variable manager
         * @note The function generates two kind of LLMV code line
         *   1) ret = expr (when ret is provided)
         *   2) expr (when ret is omitted)
         */
        std::string add_expression(const std::string&, const std::string&);
        std::string add_expression(const std::string&);

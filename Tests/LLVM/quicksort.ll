...
entry:
	...
	%id = call i64 (%struct.array_table*, i64, i64*)* @array_allocate_int(%struct.array_table* %raw_load_tmp.20, i64 0, i64* null)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 18)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 33)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 25)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 45)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 76)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 89)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 18)
	call void (%struct.array_table*, i64, i64)* @array_push_int(%struct.array_table* %raw_load_tmp.20, i64 %id, i64 19)
	...
	call void (%struct.list_table*, i64)* @list_add_reference(%struct.list_table* %raw_load_tmp.21, i64 %tmp_load_tmp_id_addr)
	...
	call void (i64)* @.quicksort(i64 %tmp_load_array.21)
	%tmp_load_array.22 = load i64* %array
	call void (i64)* @.print-array(i64 %tmp_load_array.22)
...
if_true:
	...
	call void (i64)* @println_int(i64 %tmp_load_boundary_index.1)
	...
	ret i64 %tmp_load_boundary_index.2
	br label %end_if
...
end_if:
	...
	call void (i64)* @println_int(i64 %tmp_load_pivot.2)
	%tmp_load_item_index.1 = load i64* %item_index
	call void (i64)* @println_int(i64 %tmp_load_item_index.1)
	%tmp_load_boundary_index.3 = load i64* %boundary_index
	call void (i64)* @println_int(i64 %tmp_load_boundary_index.3)
	%tmp_load_array.7 = load i64* %array
	call void (i64)* @.print-array(i64 %tmp_load_array.7)
	call void (i8)* @println_char(i8 10)
	...
	%ret.6 = call i64 (%struct.array_table*, i64, i64)* @array_get_int( %struct.array_table* %raw_load_tmp.8, i64 %tmp_load_array.8, i64 %tmp_load_item_index.2 )
	...
	%ret.7 = call i64 (%struct.array_table*, i64, i64)* @array_get_int( %struct.array_table* %raw_load_tmp.9, i64 %tmp_load_array.9, i64 %tmp_load_pivot.3 )
...
if_true.1:
	...
	call void (i64, i64, i64)* @.array-swap(i64 %tmp_load_array.10, i64 %tmp_load_boundary_index.4, i64 %tmp_load_item_index.3)
	%tmp_load_boundary_index.5 = load i64* %boundary_index
	%tmp_add.1 = add i64 %tmp_load_boundary_index.5, 1
	store i64 %tmp_add.1, i64* %boundary_index
	%tmp_load_item_index.4 = load i64* %item_index
	%tmp_add.2 = add i64 %tmp_load_item_index.4, 1
	...
	%ret.8 = call i64 (i64, i64, i64, i64)* @.partition(i64 %tmp_load_array.11, i64 %tmp_load_pivot.4, i64 %tmp_load_boundary_index.6, i64 %tmp_load_item_index.5)
	%ret.9 = alloca i64
	...
	ret i64 %tmp_load_ret.9
	br label %end_if.1

if_false.1:
	%tmp_load_item_index.6 = load i64* %item_index
	%tmp_add.3 = add i64 %tmp_load_item_index.6, 1
	...
	%tmp_load_item_index.7 = load i64* %item_index
	%ret.10 = call i64 (i64, i64, i64, i64)* @.partition(i64 %tmp_load_array.12, i64 %tmp_load_pivot.5, i64 %tmp_load_boundary_index.7, i64 %tmp_load_item_index.7)
	%ret.11 = alloca i64
...
entry:
	...
	%ret.14 = call i64 (%struct.array_table*, i64)* @array_size_int(%struct.array_table* %raw_load_tmp.16, i64 %tmp_load_array.17)
	%ret.15 = alloca i64
...
end_if.3:
	...
	%raw_load_tmp.19 = load %struct.array_table** @..array_table
	%ret.16 = call i64 (%struct.array_table*, i64)* @array_size_int(%struct.array_table* %raw_load_tmp.19, i64 %tmp_load_array.18)
	%ret.17 = alloca i64
	store i64 %ret.16, i64* %ret.17
	%tmp_load_array.19 = load i64* %array
	%tmp_load_ret.17 = load i64* %ret.17
	call void (i64, i64, i64)* @.quicksort_aux(i64 %tmp_load_array.19, i64 0, i64 %tmp_load_ret.17)
...
end_if.2:
	...
	call void (i64, i64, i64)* @.array-swap(i64 %tmp_load_array.13, i64 %tmp_load_pivot_index, i64 %tmp_load_last_index)
	...
	%ret.12 = call i64 (i64, i64, i64, i64)* @.partition(i64 %tmp_load_array.14, i64 %tmp_load_last_index.1, i64 %tmp_load_start.3, i64 %tmp_load_start.4)
	%ret.13 = alloca i64
	store i64 %ret.12, i64* %ret.13
	%pivot = alloca i64
	%tmp_load_ret.13 = load i64* %ret.13
	store i64 %tmp_load_ret.13, i64* %pivot
	call void (i64)* @println_int(i64 111111)
	%tmp_load_pivot.6 = load i64* %pivot
	call void (i64)* @println_int(i64 %tmp_load_pivot.6)
	%tmp_load_array.15 = load i64* %array
	%tmp_load_start.5 = load i64* %start
	%tmp_load_pivot.7 = load i64* %pivot
	call void (i64, i64, i64)* @.quicksort_aux(i64 %tmp_load_array.15, i64 %tmp_load_start.5, i64 %tmp_load_pivot.7)
	call void (i64)* @println_int(i64 222222)
	%tmp_load_pivot.8 = load i64* %pivot
	%tmp_add.6 = add i64 %tmp_load_pivot.8, 1
	store i64 %tmp_add.6, i64* %pivot
	%tmp_load_array.16 = load i64* %array
	%tmp_load_pivot.9 = load i64* %pivot
	%tmp_load_end.3 = load i64* %end
	call void (i64, i64, i64)* @.quicksort_aux(i64 %tmp_load_array.16, i64 %tmp_load_pivot.9, i64 %tmp_load_end.3)

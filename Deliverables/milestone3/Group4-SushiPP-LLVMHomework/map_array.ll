...
;
; DESCRIPTION: 
; This file contains the llvm code corresponding to a Sushi++ map_array code for intergers.
; The goal of the function is to apply a function at one argument to an array (of integer here).
;


; ghty
; Lambda function : return the square of an integer %nb
; The name of the function is a random name.
